#
# Be sure to run `pod spec lint FUUMultiModalPickerView.podspec' to ensure this is a
# valid spec.
#
...
Pod::Spec.new do |s|
  ...
  #                   An optional longer description of FUUMultiModalPickerView
  #
  #                   * Markdown format.
  ...
  # s.authors      = { "Constantin Lebrecht" => "constantin@monavari.de", "other author" => "and email address" }
  #
  # If absolutely no email addresses are available, then you can use this form instead.
  #
  # s.author       = 'Constantin Lebrecht', 'other author'

  # Specify the location from where the source should be retrieved.
  #
  s.source       = { :git => "https://github.com/hijolan/FUUMultiModalPickerView.git", :tag => "0.0.1" }
  # s.source       = { :svn => 'http://EXAMPLE/FUUMultiModalPickerView/tags/1.0.0' }
  # s.source       = { :hg  => 'http://EXAMPLE/FUUMultiModalPickerView', :revision => '1.0.0' }
